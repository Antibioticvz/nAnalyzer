...
@pytest.mark.asyncio
async def test_train_voice_success(client, sample_audio_base64):
...
@pytest.mark.asyncio
async def test_train_voice_insufficient_samples(client, sample_audio_base64):
...
@pytest.mark.asyncio
async def test_train_voice_user_not_found(client, sample_audio_base64):
